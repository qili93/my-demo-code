...
./lite/tools/build.sh --arm_os=android --arm_abi=armv8 --arm_lang=gcc --android_stl=c++_shared \
                      ...
                      full_publish
mv build.lite.android.armv8.gcc/ build.lite.android.armv8.gcc_full_log/
...
./lite/tools/build.sh --arm_os=android --arm_abi=armv8 --arm_lang=gcc --android_stl=c++_shared \
                      ...
                      --build_extra=ON --with_log=ON \
                      tiny_publish
mv build.lite.android.armv8.gcc/ build.lite.android.armv8.gcc_tiny_log/
cd -

# paddle full lib
base_full_dir=$base_repo_dir/build.lite.android.armv8.gcc_full_log/inference_lite_lib.android.armv8.npu
