...
cd $base_repo_dir
# build full
./lite/tools/build.sh --arm_os=android --arm_abi=armv8 --arm_lang=gcc --android_stl=c++_shared \
                      --build_npu=ON --npu_ddk_root=./ai_ddk_lib \
                      --build_extra=ON --with_log=OFF \
                      full_publish
mv build.lite.android.armv8.gcc/ build.lite.android.armv8.gcc_full_nolog/
...
./lite/tools/build.sh --arm_os=android --arm_abi=armv8 --arm_lang=gcc --android_stl=c++_shared \
                      ...
                      --build_extra=ON --with_log=OFF \
                      tiny_publish
mv build.lite.android.armv8.gcc/ build.lite.android.armv8.gcc_tiny_nolog/
cd -
...
base_full_dir=$base_repo_dir/build.lite.android.armv8.gcc_full_nolog/inference_lite_lib.android.armv8.npu
base_full_lib=$base_full_dir/cxx/lib
base_full_include=$base_full_dir/cxx/include
echo "base_full_dir=$base_full_dir"

# paddle tiny lib
base_tiny_dir=$base_repo_dir/build.lite.android.armv8.gcc_tiny_nolog/inference_lite_lib.android.armv8.npu
